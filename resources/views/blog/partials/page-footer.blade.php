    ...
    <div class="row">
      <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
        <ul class="list-inline text-center">
          ...
          {{--</li>--}}
          <li>
            <a href="https://www.facebook.com/junchi.chen.90" data-toggle="tooltip"
          ...
          {{--</li>--}}
          <li>
            <a href="http://www.linkedin.com/in/junchi-chen-457708b2/" data-toggle="tooltip"
          ...
          <li>
            <a href="https://github.com/borisitod" data-toggle="tooltip"
